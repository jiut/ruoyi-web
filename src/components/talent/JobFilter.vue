    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-2">
          <NCheckboxGroup v-model:value="selectedLocations">
            <NCheckbox
      ...
      <div>
        ...
        <div class="space-y-2">
          <NRadioGroup v-model:value="selectedExperience">
            <div class="space-y-2">
              <NRadio
      ...
      <div>
        ...
        <div class="space-y-2">
          <NCheckboxGroup v-model:value="selectedWorkTypes">
            <div class="space-y-2">
              <NCheckbox
      ...
      <div>
        ...
        <div class="space-y-2">
          <NCheckboxGroup v-model:value="selectedCompanyScales">
            <div class="space-y-2">
              <NCheckbox
      ...
      <div>
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            ...
            <NSwitch v-model:value="isUrgent" />
          </div>
          <div class="flex items-center justify-between">
            <span class="text-gray-300">支持应届生</span>
            <NSwitch v-model:value="supportFreshGraduate" />
          </div>
          <div class="flex items-center justify-between">
            <span class="text-gray-300">周末双休</span>
            <NSwitch v-model:value="weekendOff" />
          </div>
        </div>
      </div>
