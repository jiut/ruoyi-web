...
import { useSchoolFilters } from '@/composables/talent/useSchool'
...
<template>
  <div class="filter-card rounded-lg p-6 bg-white/10 backdrop-blur-md">
    ...
    <div class="flex gap-3">
      <n-button secondary class="flex-1" @click="resetFilters">
        <template #icon>
          <i class="ri-refresh-line" />
        </template>
        重置
      </n-button>
      <n-button type="primary" class="flex-1" @click="handleApplyFilters">
        <template #icon>
