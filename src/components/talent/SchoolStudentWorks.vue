    ...
    <div v-else>
      ...
      <div class="flex flex-wrap gap-2 mb-6">
        <button
          ...
          :key="category"
          class="px-4 py-2 rounded-full text-sm transition-colors" :class="[
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="text-center p-4 bg-gray-800/30 rounded-lg">
          <div class="text-xl font-bold text-purple-400 mb-1">
            {{ worksStats.publishedWorks }}
          </div>
          <div class="text-sm text-gray-400">
            发表作品
          </div>
          ...
          >
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-gray-400 mb-2">
                {{ graduate.major }} · {{ graduate.graduateYear }}届
              </p>
