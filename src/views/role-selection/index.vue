        ...
        >
          <div class="p-8">
            <div class="text-center mb-6">
              ...
              <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">设计师</h3>
              <p class="text-gray-600 dark:text-gray-300">个人设计师用户</p>
            </div>
            ...
            <div class="text-center">
              <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">角色ID: 1932319128081666050</div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="p-8">
            <div class="text-center mb-6">
              ...
              <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">企业管理员</h3>
              <p class="text-gray-600 dark:text-gray-300">企业管理用户</p>
            </div>
            ...
            <div class="text-center">
              <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">角色ID: 1932319128081666051</div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="p-8">
            <div class="text-center mb-6">
              ...
              <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">院校管理员</h3>
              <p class="text-gray-600 dark:text-gray-300">院校管理用户</p>
            </div>
            ...
            <div class="text-center">
              <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">角色ID: 1932319128081666052</div>
            </div>
          </div>
        </div>
      </div>
