...
import { getVerificationCode, reset } from '@/api/user'
        ...
        <div class="form-wrapper">
          ...
          <div class="form-content">
            ...
            <div class="input-group">
              ...
              <NInput
                v-model:value="resetForm.email" :placeholder="$t('reset.enter_email')" round clearable
            ...
            <div class="input-group">
              ...
              <div class="verification-code-row">
                <NInput
                  v-model:value="resetForm.code" :placeholder="$t('reset.enter_verification_code')" round
                ...
                <NButton :disabled="isSending" class="send-code-button" @click="sendVerificationCode">
                  {{ codeButtonText }}
                </NButton>
              </div>
            </div>
            ...
            <div class="input-group">
              ...
              <NInput
                v-model:value="resetForm.password" type="password" :placeholder="$t('reset.enter_new_password')" round
            ...
            <div class="input-group">
              ...
              <NInput
                v-model:value="resetForm.confirmPassword" type="password" :placeholder="$t('reset.enter_confirm_password')" round
            ...
            <div class="action-buttons">
              <NButton type="primary" block :loading="resetLoading" class="reset-button" @click="handleResetPassword">
                <template #icon>
