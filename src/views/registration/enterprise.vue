...
import { type EnterpriseRegistration, registerEnterprise } from '@/api/talent/registration'
...
<template>
  <div class="talent-page">
    ...
    <section class="py-6 md:py-12 relative mt-20 md:mt-16">
      <div class="absolute inset-0 bg-gradient-to-r from-orange-600/10 to-red-600/10 opacity-30" />
        ...
        <div class="glass-card rounded-lg glow-border p-6 md:p-8 max-w-4xl mx-auto">
          ...
          <div class="flex items-center justify-center mb-8">
            <div class="flex items-center space-x-4">
              <div class="w-8 h-8 rounded-full bg-gradient-to-r from-orange-600 to-red-600 flex items-center justify-center text-white text-sm font-bold">
                1
              </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div class="space-y-6">
                <div class="flex items-center mb-4">
                  <i class="ri-building-line ri-lg text-gradient mr-2" />
                ...
                <div v-if="registrationMode === 'complete'">
                  ...
                  <div class="flex items-center space-x-4">
                    <div class="w-16 h-16 rounded-lg bg-gray-700 flex items-center justify-center overflow-hidden company-logo">
                      ...
                      <i v-else class="ri-building-line text-2xl text-gray-400" />
                    </div>
                    <NUpload
                      :max="1"
                      list-type="image"
